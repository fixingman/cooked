...
interface NutritionPanelProps {
  recipe: Pick<Recipe, "calories" | "protein" | "fat" | "carbs">;
}

function Stat({ label, value, unit }: { label: string; value: number; unit: string }) {
  return (
    <div className="flex flex-col items-center gap-1 bg-parchment-200 border border-parchment-300 rounded-2xl px-4 py-3 min-w-[72px] flex-1">
  ...
  return (
    <div className="py-5 border-b border-parchment-300">
      ...
      <div className="flex gap-2">
        {calories && <Stat label="Calories" value={calories} unit="kcal" />}
